  ...
  <div id="main" class="col-md-12">
    ...
    <div class="" id="main-content">
      <!-- Sliders -->
          ...
          <div id="carousel_index" class="carousel slide col-xs-12 col-sm-12 col-md-9 col-lg-8" data-ride="carousel">
      		  <!-- Indicators -->
      ...
      <div id="index_newsletter" class="col-xs-12 col-sm-12 col-md-3 col-lg-4">
        <h3>Infolettre</h3>
