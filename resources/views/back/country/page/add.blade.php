...
@section('content')
{!! Breadcrumbs::render('country.page.add', $country) !!}
	<h4>Ajouter une page au pays : {{ $country->name }}</h4>
		<div class="row">
			<div class="col-md-12">
						
				<div class="panel-body">

					 {{ Form::open(array('route' => array('country.page.add.post', $country->code), 'method' => 'post', 'id' => 'addForm', 'class' => 'form-horizontal form-groups-bordered')) }}
