...
<h3>Gestion des newsletter</h3>
	{!! Formatter::addButton(route('newsletter.add'))!!}
			...
			@foreach($newsletters as $newsletter)
			    <tr>
					...
					<td>
						...
						{!! Formatter::button(route('newsletter.send', [$newsletter->id]), 'primary', 'fa-envelope', 'Envoyer')!!}

						{!! Formatter::editButton(route('newsletter.edit', [$newsletter->id]))!!}
						...
						{!! Formatter::delete(route('newsletter.delete', [$newsletter->id]), $newsletter->id, "Supprimer une newsletter", "Voulez-vous vraiment supprimer la newsletter " .$newsletter->name ." ?" ) !!}
