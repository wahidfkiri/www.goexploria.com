...
@section('breadcrumb')
	{!! Breadcrumbs::render('location.contact.add', $country, $location) !!}
@stop
@section('left-menu')
...
<h4>Ajouter un contact pour : {{$location->name}}</h4>
		<div class="row">
			<div class="col-md-12">
						
				<div class="panel-body">

					{{ Form::open(array('route' => array('location.contact.add.post', $country->code, $location->id), 'method' => 'post', 'id' => 'addForm', 'class' => 'form-horizontal form-groups-bordered')) }}
...
@stop
@section('js')
    {!! JsValidator::formRequest('App\Http\Requests\LocationContactRequest', '#addForm') !!}
@stop
