...
@section('breadcrumb')
	{!! Breadcrumbs::render('location.edit.hierarchie', $country, $location) !!}
@stop
@section('left-menu')
...
<h4><b>{{ Formatter::slugToNames($location->slugify()) }}</b> : Hiérarchie</h4>
...
@section('js')
{!! JsValidator::formRequest('App\Http\Requests\LocationHierarchieRequest', '#editForm'); !!}
