...
@section('content')
{!! Breadcrumbs::render('country.gallery.addmedia', $gallery->id) !!}
...
<div class="row">
	<div class="col-md-12">
      ...
      {{ Form::open(array('route' => array('country.gallery.addmedia.post'), 'method' => 'POST', 'files'=>true, 'id' => 'uploadForm', 'autocomplete' => 'off', 'class' => 'form-horizontal form-groups-bordered')) }}
        ...
        <div id="preview"></div>        
            ...
            <div class="col-md-4">
                ...
                {{ Form::open(array('route' => array('country.gallery.addvideo.post'), 'method' => 'POST', 'id' => 'uploadForm_video', 'autocomplete' => 'off', 'class' => 'form-horizontal form-groups-bordered')) }}
      ...
      <br><br>
      {!! link_to_route('country.gallery.edit', 'Retour à la galerie', [$gallery->id], ['class' => 'btn btn-default btn-sm', 'title' => 'Retour']) !!}          
      &nbsp;&nbsp; 
      {!! link_to_route('country.gallery.search', 'Liste des galeries', [], ['class' => 'btn btn-default btn-sm', 'title' => 'Retour']) !!}
      <br><br>
      
      {{ Form::open(array('route' => array('country.gallery.editmedia.post'), 'method' => 'POST', 'id' => 'editForm', 'class' => 'form-horizontal form-groups-bordered')) }}
