...
if (typeof Pace != "undefined") {
    ...
    logoImg.src = config.routes[0].root+"images/logo2.png";
            ...
            if (!soapPageLoadingContent) {
                document.getElementsByClassName("pace-activity")[0].innerHTML = '<div class="loading-page style1">' +
                                                '<div class="loading-page-wrapper">' +
                                                    '<div class="container">' +
                                                            '<h1 class="logo block">' +
                                                                '<a title="GoExploria" href="#">' +
                                                                   // '<img alt="" src="'+config.routes[0].root+'images/logo2.png">' +
                                                                   '<h1 class=\'s-title\'>GoExploria</h1>' +
                                                                '</a>' +
                                                            '</h1>' +
